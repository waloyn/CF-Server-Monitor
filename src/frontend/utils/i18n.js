...
const translations = reactive({
  en: {
    ...
    customBd: 'BD Node',
    jwtSecretTip: 'JWT secret is used to generate and verify login tokens. Leave empty to keep the current value. Use a random string of at least 32 characters.',
    ...
    jwtSecretPlaceholder: 'Leave empty to keep current value',
  ...
  zh: {
    ...
    customCm: '中国移动测试节点',
    customBd: 'BD测试节点',
    jwtSecretTip: 'JWT密钥用于生成和验证登录token。留空表示不修改当前密钥。使用至少32个字符的随机字符串。',
    ...
    jwtSettings: 'JWT 设置',
    jwtSecret: 'JWT 密钥',
    jwtSecretPlaceholder: '留空表示不修改当前密钥',
    monthlyTraffic: '月度流量',
